...
| `mobile_expo_engineer` | Mobile Expo Engineer Agent | Specialist | Implement and validate Expo/React Native mobile foundation, navigation, storage spikes, and local app scaffolding | `prompts/agents/mobile_expo_engineer.prompt.md` | `agents/implementation/mobile_expo_engineer.md` |
| `map_provider_engineer` | Map Provider Engineer Agent | Specialist | Validate map SDKs, offline map packs, tile/style providers, attribution, and map/search adapter proofs | `prompts/agents/map_provider_engineer.prompt.md` | `agents/implementation/map_provider_engineer.md` |
